...
// Soft: AgentProfile.status=INACTIVE. Permanent: delete User (cascades profile).
    ...
    if (permanent) {
      try {
        ...
        if ((e as { code?: string }).code === 'P2003') {
          throw new Error('Cannot delete permanently: this agent has orders assigned. Deactivate instead.');
        }
        throw e;
      }
    }
