  ...
  return (
    <LegalPage title="Genetic Testing Consent" updated="14 May 2026">
      ...
      <p>
        ...
        writing to <a href="mailto:privacy@knowyourgenes.in">privacy@knowyourgenes.in</a> or from &ldquo;Privacy&rdquo;
      ...
      <p>
        ...
        <br />
        Email: <a href="mailto:privacy@knowyourgenes.in">privacy@knowyourgenes.in</a> /{' '}
