  ...
  return (
    <svg viewBox="0 0 729.85 318.67" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden="true">
      <g fill="none" stroke={wordmark} strokeWidth="19.02" strokeLinecap="round" strokeMiterlimit="10">
        ...
        <path d="M498.81,134.54c5.95,5.16,8.39,7.43,12.15,11.07,34.34,33.36,54.01,44.25,88.7,44.25s79.48-22.74,79.48-79.38h-67.62" strokeLinejoin="round" />
      ...
      <text fill={wordmark} fontSize="96.98" fontFamily="Figtree, sans-serif" fontWeight="700" transform="translate(0 297.34)">
        <tspan x="0" y="0">K</tspan><tspan x="63.91" y="0">n</tspan><tspan x="118.99" y="0" fontWeight="400">o</tspan><tspan x="173.2" y="0">w</tspan><tspan x="254.18" y="0" fontWeight="400">Y</tspan><tspan x="306.94" y="0" fontWeight="400">our</tspan><tspan x="450.07" y="0">Genes</tspan>
      </text>
    </svg>
  );
}
