    ...
    <section className="py-[72px] lg:py-[88px]">
      <Container>
        <div className="reveal max-w-[780px]">
          <Eyebrow icon={<FigIcon src="/landing/_icons/eb-calendar.svg" className="size-[19px]" />}>At every age</Eyebrow>
    ...
    <section className="relative overflow-hidden py-[80px] lg:py-[100px]">
      ...
      <Container>
        <div className="reveal max-w-[760px]">
          <Eyebrow icon={<FigIcon src="/landing/_icons/eb-quote.svg" className="size-[19px]" />}>In their words</Eyebrow>
      ...
      <Container>
        <div className="reveal relative overflow-hidden rounded-[36px] bg-[#15201E]">
          ...
          <div className="relative max-w-[640px] p-8 sm:p-12 lg:p-[64px]">
            <Eyebrow tone="dark" icon={<FigIcon src="/landing/_icons/eb-trending-up.svg" className="size-[19px]" />}>
            ...
            <p className="mt-[24px] text-[15.5px] leading-[25.19px] text-[rgba(250,246,239,0.8)]">
              ...
              Standard folic acid does not work the same way for MTHFR carriers. Methylfolate does. A simple, inexpensive
              switch that most women never make, because no one told them to test.
            </p>
    ...
    <section id="how" className="py-[72px] lg:py-[88px]">
      <Container>
        <div className="reveal max-w-[640px]">
          <Eyebrow icon={<FigIcon src="/landing/_icons/eb-package.svg" className="size-[19px]" />}>How it works</Eyebrow>
