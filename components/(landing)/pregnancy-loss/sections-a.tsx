        ...
        <div className="lg:grid lg:grid-cols-[minmax(0,600px)_minmax(0,1fr)] lg:items-center">
          ...
          <div className="relative z-10 rounded-[34px] border border-white/70 bg-[rgba(250,246,239,0.85)] p-7 shadow-[0_24px_70px_-30px_rgba(20,45,40,0.4)] backdrop-blur-[24px] sm:p-10 lg:py-[44px] lg:pl-[40px] lg:pr-[64px] lg:mr-[-72px]">
            ...
            <p className="mt-[20px] max-w-[520px] text-[16px] leading-[1.5] text-[#2D2A24] lg:text-[18px] lg:leading-[27.9px]">
              Miscarriage occurs in <strong className="font-semibold text-[#1F1A14]">10 to 20% of known pregnancies.</strong>{' '}
              Most are called unexplained. But your <strong className="font-semibold text-[#0E4D4B]">MTHFR and FOXP3</strong>{' '}
              gene variants may hold the explanation your doctors couldn’t give you, and the information you need to
              protect your next pregnancy.
            </p>
          ...
          <div className="mt-10 lg:mt-0 z-10">
            <div className="relative mx-auto aspect-[589/600] w-full max-w-[589px] overflow-hidden rounded-[36px] bg-[#E4F1EC] shadow-[0_40px_100px_rgba(20,45,40,0.15),0_12px_36px_rgba(20,45,40,0.1)]">
              ...
              <div
                ...
                style={{ background: 'linear-gradient(161deg, rgba(14,77,75,0.04) 0%, rgba(14,77,75,0.1) 50%, rgba(14,77,75,0.5) 100%)' }}
              />
              {/* stat chip */}
      ...
      <Container>
        <div className="reveal max-w-[760px]">
          ...
          <p className="mt-[20px] max-w-[620px] text-[17px] leading-[28px] text-[#2D2A24] lg:text-[18.7px] lg:leading-[30.42px]">
            Real women, telling real stories, so the woman reading this knows that what happened to her is common, is not
            her fault, and is not always unexplainable.
          </p>
        </div>
        ...
        <div className="mt-[32px] grid gap-[24px] md:grid-cols-2 lg:grid-cols-3">
          {VOICES.map((v) => (
            ...
            >
              <div className="pointer-events-none absolute -right-5 -top-5 size-[112px] rounded-full blur-[40px]" style={{ background: v.blob }} />
            ...
            >
              <div className="flex items-center gap-[16px]">
                ...
                <div>
                  ...
                  <div className="text-[22px] font-semibold leading-[1] tracking-[-0.025em] text-[#1F1A14]">{g.gene}</div>
                </div>
              </div>
          ...
          <div className="reveal">
            ...
            <div className="mt-[24px] rounded-[22px] border border-[rgba(31,26,20,0.08)] bg-white/70 px-[24px] pb-[24px] pt-[28px]">
              ...
              <p className="mt-[10px] text-[14.5px] leading-[23.56px] text-[#2D2A24]">
                This test is not about looking back. It’s about looking forward with better information. It will not undo
                what happened. But it may explain it, and it may make everything that comes next more possible.
              </p>
            </div>
          </div>
