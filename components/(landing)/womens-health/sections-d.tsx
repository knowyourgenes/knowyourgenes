      ...
      <Container>
        <div className="grid items-center gap-[48px] lg:grid-cols-2">
          ...
          <div className="reveal-r flex flex-col gap-[16px]">
            <Eyebrow icon={<FigIcon src="/landing/_icons/eb-trust.svg" className="size-[19px]" />}>Trust</Eyebrow>
      ...
      <Container>
        <div className="mx-auto max-w-[860px]">
          <div className="reveal">
            <Eyebrow icon={<FigIcon src="/landing/_icons/eb-faqs.svg" className="size-[19px]" />}>FAQs</Eyebrow>
    ...
    <section className="py-[72px] lg:py-[88px]">
      <Container>
        <div className="reveal max-w-[760px]">
          <Eyebrow icon={<FigIcon src="/landing/_icons/eb-alsopart.svg" className="size-[19px]" />}>One sample, five answers</Eyebrow>
