        ...
        <div className="mt-[40px] grid items-start gap-[40px] lg:grid-cols-2">
          ...
          <div className="reveal flex flex-col gap-[18px]">
            <p className="text-[17px] leading-[27.63px] text-[#2D2A24]">
              ...
              encodes an enzyme that does one critical job: it breaks down dopamine and estrogen byproducts in your body.
            </p>
            <p className="text-[17px] leading-[27.63px] text-[#2D2A24]">
            ...
            <p className="text-[17px] font-medium leading-[27.63px] text-[#1F1A14]">
              This is not a personality issue. This is a metabolic process. And knowing your COMT variant changes how you
              and your doctor approach every pregnancy.
            </p>
          </div>
            ...
            <div className="flex flex-col gap-[6px]">
              ...
              <div className="flex items-center gap-[16px] rounded-[16px] bg-[#0E4D4B] p-[16px]">
                ...
                <div>
                  ...
                  <div className="text-[13px] leading-[19.5px] text-[rgba(250,246,239,0.7)]">manageable, once you know</div>
                </div>
              </div>
            </div>
          </div>
