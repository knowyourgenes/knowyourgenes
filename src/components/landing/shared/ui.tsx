  ...
  return (
    ...
    >
      ...
      <FigIcon
        ...
        className="size-[19px] transition-transform group-hover:translate-x-[3px]"
      />
    </a>
  );
}
 ...
 *  `text-[…]` class (e.g. `<FigIcon src="/landing/icons/x.svg" className="size-[19px] text-[#0E4D4B]" />`). */
...
/** The small KYG mark + wordmark lockup used in the mock-report card headers. */
export function ReportLogo() {
  return (
    <span className="inline-flex items-center gap-[6px] text-[#FAF6EF]">
      <FigIcon src="/landing/icons/kyg-logo-mark.svg" className="size-[16px] text-[#F3D5B2]" />
