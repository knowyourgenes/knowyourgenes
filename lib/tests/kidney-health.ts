...
export const kidneyHealth: TestPage = {
  ...
  sections: [
    // --------------------------------------------------------------- hero ----
    {
      ...
      image: { src: `${IMG}/hero-filter.webp`, alt: 'Clean water passing through a filter, calm and clear' },
      resultCard: {
        title: 'Your findings',
        icon: 'flask',
        rows: [
      ...
      cards: [
        {
          ...
          tabLabel: 'Uric Acid',
          icon: 'flask',
          image: { src: `${IMG}/risk-hyperuricemia.webp`, alt: 'Uric acid crystallising in a joint' },
        ...
        },
        {
          ...
          tabLabel: 'Polycystic',
          icon: 'cyst',
          image: { src: `${IMG}/risk-polycystic.webp`, alt: 'Fluid-filled cysts crowding kidney tissue' },
        ...
        },
        {
          ...
          tabLabel: 'Magnesium',
          icon: 'zap',
          image: { src: `${IMG}/risk-magnesium.webp`, alt: 'Minerals held in balance, or lost' },
        ...
        },
        {
          ...
          icon: 'heart',
          image: { src: `${IMG}/risk-ckd.webp`, alt: 'Filtering capacity slipping over time' },
        ...
        },
        {
          ...
          tabLabel: 'Membranous',
          icon: 'shield-plus',
          image: { src: `${IMG}/risk-membranous.webp`, alt: "The kidney's filtering vessels thickening" },
        ...
        },
        {
          ...
          tabLabel: 'Stones',
          icon: 'gem',
          image: { src: `${IMG}/risk-stones.webp`, alt: 'Minerals hardening into a kidney stone' },
    ...
    // --------------------------------------------------------- counsellor ----
    {
      ...
      image: { src: `${IMG}/counsellor.webp`, alt: 'A KYG genetics expert reviewing a kidney finding' },
      points: [
