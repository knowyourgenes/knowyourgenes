...
export const skinHealth: TestPage = {
  ...
  sections: [
    ...
    // --------------------------------------------------------- aspiration ----
    {
      ...
      image: { src: `${IMG}/why-reactive.webp`, alt: 'Skin in daylight beside skin under a UV light' },
    ...
    // --------------------------------------------------------- risk cards ----
    {
      ...
      cards: [
        ...
        },
        {
          ...
          tabLabel: 'Glycation',
          icon: 'sugar',
          image: { src: `${IMG}/risk-glycation.webp`, alt: 'Sugar stiffening collagen fibres' },
        ...
        },
        {
          ...
          icon: 'hourglass',
          image: { src: `${IMG}/risk-age.webp`, alt: 'Cell age running ahead of birthday age' },
        ...
        },
        {
          ...
          tabLabel: 'Cellulite',
          icon: 'cellulite',
          image: { src: `${IMG}/risk-cellulite.webp`, alt: 'Uneven, dimpled skin texture' },
        ...
        },
        {
          ...
          icon: 'stretch',
          image: { src: `${IMG}/risk-stretch.webp`, alt: 'Skin tearing under rapid stretch' },
        ...
        },
        {
          ...
          tabLabel: 'Acne',
          icon: 'acne',
          image: { src: `${IMG}/risk-acne.webp`, alt: 'Oil production and immune signalling in skin' },
        ...
        },
        {
          ...
          tabLabel: 'Pollution',
          icon: 'air',
          image: { src: `${IMG}/risk-pollution.webp`, alt: 'City air settling on skin' },
