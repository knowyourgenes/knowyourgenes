...
export const skinHealth: TestPage = {
  ...
  sections: [
    // --------------------------------------------------------------- hero ----
    {
      ...
      image: { src: `${IMG}/hero-skin.png`, alt: 'A close-up of skin, clear and calm' },
      resultCard: {
        title: 'Your findings',
        icon: 'flask',
        rows: [
      ...
      cards: [
        {
          ...
          tabLabel: 'Oxidative',
          icon: 'shield',
          image: { src: `${IMG}/risk-oxidative.png`, alt: 'Free radicals breaking down collagen' },
        ...
        },
        {
          ...
          icon: 'flame',
          image: { src: `${IMG}/risk-inflammation.png`, alt: 'Redness that keeps returning' },
        ...
        },
        {
          ...
          tabLabel: 'Texture',
          icon: 'texture',
          image: { src: `${IMG}/risk-texture.png`, alt: 'Collagen losing its structure' },
        ...
        },
        {
          ...
          tabLabel: 'Sun',
          icon: 'sun',
          image: { src: `${IMG}/risk-sun.png`, alt: 'A lifetime of UV exposure adding up' },
    ...
    // --------------------------------------------------------- counsellor ----
    {
      ...
      image: { src: `${IMG}/counsellor.png`, alt: 'A KYG genetics expert reviewing a skin finding' },
      points: [
