...
export const immunityHealth: TestPage = {
  ...
  sections: [
    ...
    // --------------------------------------------------------- aspiration ----
    {
      ...
      image: { src: `${IMG}/why-reactive.webp`, alt: 'A shield holding, and a shield with a gap' },
      ...
      cards: [
        {
          ...
          tabLabel: 'Bacterial',
          icon: 'virus',
          image: { src: `${IMG}/risk-bacterial.webp`, alt: 'A fast-moving bacterial infection' },
        ...
        },
        {
          ...
          icon: 'microscope',
          image: { src: `${IMG}/risk-gramneg.webp`, alt: 'Immune receptors recognising a pathogen' },
        ...
        },
        {
          ...
          tabLabel: 'Parasitic',
          icon: 'droplet',
          image: { src: `${IMG}/risk-parasitic.webp`, alt: 'Red blood cells and the malaria parasite' },
        ...
        },
        {
          ...
          tabLabel: 'HIV',
          icon: 'shield-plus',
          image: { src: `${IMG}/risk-hiv.webp`, alt: 'Viral load under immune control' },
        ...
        },
        {
          ...
          tabLabel: 'SARS-CoV',
          icon: 'biohazard',
          image: { src: `${IMG}/risk-sars.webp`, alt: 'Susceptibility to the SARS-CoV family' },
        ...
        },
        {
          ...
          tabLabel: 'Fungal',
          icon: 'sprout',
          image: { src: `${IMG}/risk-fungal.webp`, alt: 'Immune pattern recognition of fungi' },
        ...
        },
        {
          ...
          tabLabel: 'Bowel',
          icon: 'bandage',
          image: { src: `${IMG}/risk-ibd.webp`, alt: 'Inflammation along the gut lining' },
        ...
        },
        {
          ...
          tabLabel: 'Asthma',
          icon: 'air',
          image: { src: `${IMG}/risk-asthma.webp`, alt: 'An elevated allergic airway response' },
        ...
        },
        {
          ...
          tabLabel: 'COVID-19',
          icon: 'heart',
          image: { src: `${IMG}/risk-covid.webp`, alt: 'How severely the body responds to COVID-19' },
    ...
    // ----------------------------------------------------------- contrast ----
    {
      ...
      negative: {
        ...
        image: { src: `${IMG}/contrast-never.webp`, alt: 'Someone unwell again, still guessing' },
      ...
      positive: {
        ...
        image: { src: `${IMG}/contrast-tested.webp`, alt: 'Someone healthy years later, having acted early' },
