...
import { Container, Eyebrow, FigIcon, GradientText, SheenButton, gCopper } from '../shared/ui';
    ...
    <section className="relative overflow-hidden py-[80px] lg:py-[100px]">
      ...
      <Container>
        <div className="reveal max-w-[760px]">
          <Eyebrow icon={<FigIcon src="/landing/icons/eb-testimonials.svg" className="size-[19px]" />}>
            In their words
          </Eyebrow>
        ...
        <div className="mt-[48px] grid gap-[24px] md:grid-cols-2 lg:grid-cols-3">
          {TESTIMONIALS.map((t) => (
            <figure
              key={t.name}
              className="reveal flex flex-col rounded-sm border border-[rgba(31,26,20,0.08)] bg-white/80 p-[32px] shadow-[0_4px_14px_rgba(45,32,18,0.04),0_1px_2px_rgba(45,32,18,0.04)]"
            >
...
export function AtEveryAgeSection() {
  return (
    <section className="py-[72px] lg:py-[88px]">
      <Container>
        <div className="reveal max-w-[760px]">
          <Eyebrow icon={<FigIcon src="/landing/icons/eb-ateveryage.svg" className="size-[19px]" />}>
            At every age
          </Eyebrow>
...
export function FomoSection() {
  return (
    <section className="py-[40px] lg:py-[60px]">
      <Container>
        <div className="reveal relative overflow-hidden rounded-sm bg-[#1A2220]">
          ...
          <div className="relative max-w-[640px] p-8 sm:p-12 lg:p-[64px]">
            <Eyebrow tone="dark" icon={<FigIcon src="/landing/icons/eb-fomo.svg" className="size-[19px]" />}>
    ...
    <section id="how" className="py-[72px] lg:py-[88px]">
      <Container>
        <div className="reveal max-w-[640px]">
          <Eyebrow icon={<FigIcon src="/landing/icons/eb-howitworks.svg" className="size-[19px]" />}>
            How it works
          </Eyebrow>
