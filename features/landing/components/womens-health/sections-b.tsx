...
const OUTCOMES = [
  {
    icon: '/landing/icons/trending-up.svg',
  ...
  {
    icon: '/landing/icons/wh-circle-check.svg',
  ...
  {
    icon: '/landing/icons/wh-check-badge.svg',
    ...
    <section id="why" className="py-[72px] lg:py-[88px]">
      <Container>
        <div className="reveal max-w-[760px]">
          <Eyebrow icon={<FigIcon src="/landing/icons/eb-whytest.svg" className="size-[19px]" />}>
            Why test genetically
          </Eyebrow>
        ...
        <div className="mt-[40px] grid gap-[24px] lg:grid-cols-2">
          ...
          <div className="reveal rounded-sm bg-[#1A2220] p-[40px]">
            ...
            <p className="mt-[20px] text-[20px] leading-[32.5px] text-[rgba(250,246,239,0.95)]">
              The average Indian woman sees <span className="font-semibold text-[#F3D5B2]">3 to 4 doctors</span> before
              a definitive diagnosis.
            </p>
            <ul className="mt-[24px] flex flex-col gap-[12px]">
              {DISMISSED.map((d) => (
                <li key={d} className="flex items-center gap-[12px]">
                  <FigIcon src="/landing/icons/x.svg" className="size-[18px] shrink-0 text-[rgba(250,246,239,0.4)]" />
        ...
        <div className="reveal mt-[24px] grid overflow-hidden rounded-sm border border-[rgba(31,26,20,0.08)] sm:grid-cols-2">
          ...
          <div className="relative flex flex-col gap-[11px] overflow-hidden bg-[#0E4D4B] p-[36px]">
            ...
            <span className="relative inline-flex items-center gap-[8px] text-[11px] font-semibold uppercase tracking-[0.16em] text-[rgba(243,213,178,0.85)]">
              <FigIcon src="/landing/icons/wh-dna-strand.svg" className="size-[18px]" />A genetic test
            </span>
    ...
    <div className="reveal-r overflow-hidden rounded-sm border border-[rgba(31,26,20,0.08)] bg-white shadow-[0_40px_100px_rgba(45,32,18,0.14),0_12px_36px_rgba(45,32,18,0.1)]">
      ...
      >
        ...
        <div className="relative mt-[8px] flex items-center gap-[8px]">
          <FigIcon src="/landing/icons/dna.svg" className="size-[22px] text-[#FAF6EF]" />
      ...
      <Container>
        <div className="grid items-start gap-[56px] lg:grid-cols-2 lg:gap-[48px]">
          <div className="reveal">
            <Eyebrow icon={<FigIcon src="/landing/icons/eb-whatyouget.svg" className="size-[19px]" />}>
              What you get
            </Eyebrow>
            <h2 className="mt-[20px] text-[34px] font-semibold leading-[1.05] tracking-[-0.022em] text-[#1F1A14] sm:text-[40px] lg:text-[44px] lg:leading-[47.52px]">
              Your PCOS genetic result. <span className="font-medium text-[#6B6358]">In plain language.</span>
            </h2>
              ...
              {GET_BULLETS.map((b, i) => (
                <li key={i} className="flex items-start gap-[14px]">
                  <span className="mt-[1px] grid size-[22px] shrink-0 place-items-center rounded-full bg-[rgba(14,77,75,0.1)] text-[#0E4D4B]">
                    <FigIcon src="/landing/icons/wh-dna-strand.svg" className="size-[14px]" />
                  </span>
    ...
    <section className="bg-[#1A2220] py-[80px] lg:py-[100px]">
      <Container>
        <div className="reveal max-w-[720px]">
          <Eyebrow tone="dark" icon={<FigIcon src="/landing/icons/eb-data.svg" className="size-[19px]" />}>
            By the numbers
          </Eyebrow>
  ...
  },
  {
    ...
    after: (
      <span className="text-[#2D2A24]">
        ...
        <strong className="font-semibold text-[#1F1A14]">Targeted fertility support started.</strong> Ovulation
        induction discussed earlier than usual.
      </span>
    ),
  },
  {
...
export function BeforeAfterSection() {
  return (
    <section className="py-[72px] lg:py-[88px]">
      <Container>
        <div className="reveal max-w-[760px]">
          <Eyebrow icon={<FigIcon src="/landing/icons/eb-beforeafter.svg" className="size-[19px]" />}>
            Before &amp; after
          </Eyebrow>
