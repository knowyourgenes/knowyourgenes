...
import { Container, Eyebrow, FigIcon, GradientText, SheenButton, gTeal } from '../shared/ui';
...
const GET_BULLETS: { icon: string; node: React.ReactNode }[] = [
  {
    icon: '/landing/icons/dna-helix.svg',
    node: (
      <>
  ...
  return (
    <div className="reveal-r overflow-hidden rounded-7.5 border border-[rgba(31,26,20,0.08)] bg-white shadow-[0_40px_100px_rgba(20,45,40,0.15),0_12px_36px_rgba(20,45,40,0.1)]">
      ...
      >
        ...
        <div className="relative mt-5 text-3 font-semibold uppercase tracking-[0.14em] text-[rgba(243,213,178,0.8)]">
          Peripartum Depression Risk
        </div>
        <div className="relative mt-2 flex items-center gap-2">
          <FigIcon src="/landing/icons/brain.svg" className="size-5 text-[#FAF6EF]" />
          <span className="text-5 font-semibold leading-[1.2] tracking-[-0.025em] text-[#FAF6EF]">
      ...
      <div className="flex flex-col gap-4 px-8 py-7">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="rounded-4 bg-[rgba(199,104,66,0.1)] px-5 pb-6 pt-4.75">
            ...
            <div className="mt-2 inline-flex items-center gap-2">
              <span className="size-2.5 rounded-full bg-[#C76842]" />
              <span className="text-5 font-semibold leading-7.5 text-[#C76842]">Poor</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-1.25 rounded-4 bg-[rgba(14,77,75,0.06)] p-4">
          ...
          <p className="text-[13.5px] leading-[21.94px] text-[#2D2A24]">
            During pregnancy, eat healthy foods. Refrain from processed foods, caffeine, smoking and alcohol. Meditate
            15 minutes daily. Take adequate rest. Build a mental health support plan with your doctor before delivery.
          </p>
        </div>
        ...
        <p className="border-t border-[rgba(31,26,20,0.08)] pt-4 text-[12.5px] italic leading-[20.31px] text-[#6B6358]">
      ...
      <Container>
        <div className="grid items-start gap-14 lg:grid-cols-2 lg:gap-12">
          <div className="reveal">
            <Eyebrow icon={<FigIcon src="/landing/icons/eb-whatyouget.svg" className="size-4.75" />}>
              What you get
            </Eyebrow>
            <h2 className="mt-5 text-[34px] font-semibold leading-[1.05] tracking-[-0.022em] text-[#1F1A14] sm:text-10 lg:text-11 lg:leading-[47.52px]">
              Your COMT result.{' '}
            ...
            <ul className="mt-6 flex flex-col gap-4">
              {GET_BULLETS.map((b, i) => (
                <li key={i} className="flex items-start gap-3.5">
                  <FigIcon src={b.icon} className="mt-[1px] size-6 shrink-0 text-[#0E4D4B]" />
...
const CHANGES = [
  ...
  {
    icon: '/landing/icons/stethoscope.svg',
...
export function WhatKnowingChangesSection() {
  return (
    <section id="changes" className="py-18 lg:py-22">
      <Container>
        <div className="reveal max-w-190">
          <Eyebrow icon={<FigIcon src="/landing/icons/eb-knowing.svg" className="size-4.75" />}>
            What knowing changes
          </Eyebrow>
          <h2 className="mt-4.5 text-[34px] font-semibold leading-[1.08] tracking-[-0.022em] text-[#1F1A14] sm:text-10 lg:text-11 lg:leading-[47.52px]">
            What changes when you know your COMT variant.
          </h2>
          <p className="mt-5 text-[17px] leading-7 text-[#2D2A24] lg:text-[18.7px] lg:leading-[30.42px]">
          ...
          <div className="relative flex flex-col items-start gap-5 sm:flex-row sm:items-center">
            ...
            <p className="text-5.5 font-semibold leading-[1.28] tracking-[-0.015em] sm:text-[25px] lg:text-[27px] lg:leading-[34.56px]">
              <span className="text-[#FAF6EF]">
                A COMT risk variant does not mean you will have peripartum depression. It means you know to
                prepare.{' '}
              </span>
...
const STATS = [
  ...
  { n: 'COMT', c: '#2AC3A2', label: 'controls dopamine breakdown, pain threshold, stress sensitivity', small: true },
  {
    n: 'Low',
    c: '#F3D5B2',
    label: 'COMT activity means dopamine builds up, raising stress vulnerability',
    small: true,
  },
    ...
    <section className="bg-[#15201E] py-[80px] lg:py-[100px]">
      <Container>
        <div className="reveal max-w-[720px]">
          <Eyebrow tone="dark" icon={<FigIcon src="/landing/icons/eb-data.svg" className="size-4.75" />}>
            By the numbers
          </Eyebrow>
          <h2 className="mt-5.5 text-[34px] font-semibold leading-[1.06] tracking-[-0.022em] text-[#FAF6EF] sm:text-10 lg:text-11 lg:leading-[47.52px]">
        ...
        <div className="mt-12 grid grid-cols-2 gap-px overflow-hidden rounded-7 bg-white/10 lg:grid-cols-4">
          {STATS.map((s) => (
            <div key={s.label} className="flex flex-col gap-3 bg-[#15201E] p-7 sm:p-8">
              <div
                className={`font-hind font-semibold leading-none tracking-[-0.025em] ${s.small ? 'text-8 sm:text-[38px]' : 'text-10 lg:text-[50px]'}`}
                style={{ color: s.c }}
              >
                {s.n}
              </div>
              <p className="text-3.5 leading-[19.25px] text-[rgba(250,246,239,0.7)]">{s.label}</p>
            </div>
          ))}
        </div>
      </Container>
...
export function BeforeAfterSection() {
  return (
    <section className="py-18 lg:py-22">
      <Container>
        <div className="reveal max-w-190">
          <Eyebrow icon={<FigIcon src="/landing/icons/eb-beforeafter.svg" className="size-4.75" />}>
            Before &amp; after
          </Eyebrow>
          <h2 className="mt-5 text-[34px] font-semibold leading-[1.07] tracking-[-0.022em] text-[#1F1A14] sm:text-10 lg:text-11 lg:leading-[47.52px]">
        ...
        {STATEMENTS.map((label, i) => (
          <li key={i}>
            <button
              ...
              className={`sx-row flex w-full items-start gap-4 px-2 py-4 text-left ${
      ...
      >
        ...
        >
          <span className="relative z-[1] inline-flex items-center gap-2">
            Know my genetic vulnerability
            <FigIcon src="/landing/icons/arrow.svg" className="size-4.75" />
          </span>
        </a>
      </div>
    </div>
    ...
    <section id="who" className="relative overflow-hidden py-[80px] lg:py-[100px]">
      ...
      <Container>
        <div className="grid items-start gap-12 lg:grid-cols-2">
          <div className="reveal">
            <Eyebrow icon={<FigIcon src="/landing/icons/eb-heart.svg" className="size-4.75" />}>
              Who this is for
            </Eyebrow>
            <h2 className="mt-5 text-[34px] font-semibold leading-[1.05] tracking-[-0.022em] text-[#1F1A14] sm:text-10 lg:text-11 lg:leading-[47.52px]">
  ...
  },
  {
    ...
    body: (
      <>
        ...
        give you the <strong className="font-medium text-[#2D2A24]">first biological explanation you’ve had.</strong>{' '}
        And a different plan for next time.
      </>
    ),
  },
  {
...
export function AtEveryAgeSection() {
  return (
    <section className="py-18 lg:py-22">
      <Container>
        <div className="reveal max-w-195">
          <Eyebrow icon={<FigIcon src="/landing/icons/eb-ateveryage.svg" className="size-4.75" />}>
            At every age
          </Eyebrow>
          <h2 className="mt-5 text-[34px] font-semibold leading-[1.07] tracking-[-0.022em] sm:text-10 lg:text-11 lg:leading-[48.4px]">
            ...
            {AGES.map((a) => (
              <div key={a.age} className="reveal flex flex-col gap-[7px]">
                <div className="flex items-center gap-3">
                  <span
                    className={`grid size-6 shrink-0 place-items-center rounded-full ${a.copper ? 'bg-[#C76842]' : 'bg-[#0E4D4B]'}`}
                  >
                    <span className="size-2 rounded-full bg-[#FAF6EF]/85" />
                  </span>
                  <span className="font-hind text-4.5 font-semibold leading-[27px] tracking-[-0.025em] text-[#1F1A14]">
                    {a.age}
                  </span>
                </div>
                <h3 className="mt-3 text-[17px] font-semibold leading-[25.5px] tracking-[-0.025em] text-[#1F1A14]">
                  {a.title}
                </h3>
